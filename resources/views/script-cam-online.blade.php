...
Programa Arduino - Arduino Camera IP Wifi Control.ino:
          ...
          Programa Arduino - Arduino Camera IP Wifi Control.ino.
Código acionamento de fechadura elétrica, intalado em Arduino pinos digitais: D6, D7e D8.
Divice 10,11 e 12 tempo do pulso em 2 segundos, relé contato temporizado em 2000ms. 
<pre>
...
//-----------------------------
contD6++;//Incrementa contagem;
contD7++;//Incrementa contagem;
contD8++;//Incrementa contagem;
//-----------------------------
 
 if(contD6 >= 200)// Tempo = 10ms x 200 = 2 segundos, Device10;
{
 // Turn OFF the Relay.
 digitalWrite(D6, HIGH);
...
//----------------------
 if(contD7 >= 200)// Tempo = 10ms x 200 = 2 segundos, Device11;
{
  //Turn OFF the Relay.
 digitalWrite(D7, HIGH);
...
//----------------------
 if(contD8 >= 200)// Tempo = 10ms x 200 = 2 segundos, Device12;
{
 // Turn OFF the Relay.
 digitalWrite(D8, HIGH);
...
//------------------------------------------------------------------      
          if(readString.indexOf("d6high")>=0)//Recebido do Android;
          {
           // Turn ON the Relay.
            ...
            statusD6 = true;
            contD6=0;//Zera a contagem de 2 segundos;
          }
          // Se a string possui o texto L=Desligar
...
//------------------------------------------------------------------      
          if(readString.indexOf("d7high")>=0)//Recebido do Android;
          {
           // Turn ON the Relay.
            ...
            statusD7 = true;
            contD7=0;//Zera a contagem de 2 segundos;
          }
          // Se a string possui o texto L=Desligar
...
//------------------------------------------------------------------      
          ...
          // Turn ON the Relay.
            ...
            statusD8 = true;
            contD8=0;//Zera a contagem de 2 segundos;
          }
          // Se a string possui o texto L=Desligar
...
delay(10);//Base de tempo para contagem de D6, D7 e D8;
