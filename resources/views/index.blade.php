            ...
            <div class="container">
              <div class="box">
                <div class="row">
                  ...
                  <div class="col-md-5">
                    <div class="img-box">
                      <img src="images/camera-slide-1.png" alt="" />
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="container">
              <div class="box">
                <div class="row">
                  ...
                  <div class="col-md-5">
                    <div class="img-box">
                      <img src="images/camera-slide.png" alt="" />
                    </div>
                  </div>
                </div>
              </div>
...
<?xml version="1.0" encoding="UTF-8"?> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-code" viewBox="0 0 16 16"> <path d="M5.854 4.854a.5.5 0 1 0-.708-.708l-3.5 3.5a.5.5 0 0 0 0 .708l3.5 3.5a.5.5 0 0 0 .708-.708L2.707 8l3.147-3.146zm4.292 0a.5.5 0 0 1 .708-.708l3.5 3.5a.5.5 0 0 1 0 .708l-3.5 3.5a.5.5 0 0 1-.708-.708L13.293 8l-3.147-3.146z"/> </svg> 
        ...
        <div class="detail-box">
          ...
          <p>
            Mostramos como e que podemos criar cams online
          </p>
        </div>
      </a>
      </a> 
 ...
 Mostramos como e que podemos criar scripts detetor imagens 3d
  ...
  <section class="about_section layout_padding-bottom">
    <div class="container">
      <div class="heading_container">
        <h2>
          Sobre o Do it Yourself Security Camera
        </h2>
      </div>
      <div class="box">
        <div class="img-box">
          <img src="images/secamera.png" width="300px" height="300px" alt="">
        </div>
        <div class="detail-box">
          <p> <br> <br>
            Bem-vindo ao "Do It Yourself Security Camera", o seu destino online para obter informações e inspiração sobre câmeras de segurança DIY. Neste site, estamos empenhados em ajudar você a projetar e construir o seu próprio sistema de segurança, com instruções detalhadas, dicas úteis e exemplos de código para tornar tudo isso possível.
